...
impl Config {
    pub fn from_args() -> Config {
        ...
        match network_type {
            ...
            #[cfg(not(feature = "liquid"))]
            Network::OpnetTestnet => daemon_dir.push("opnet-testnet"),
